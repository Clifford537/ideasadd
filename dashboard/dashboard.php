...
<head>
    ...
    @media (max-width: 576px) {
        ...
        .card-title {
            font-size: 6rem; /* Larger font size for card titles on small screens */
        }
        .card-text {
            font-size: 7rem; 
        ...
        .icon {
            font-size: 2rem; /* Icon size on small screens */
        }
        .badge {
            font-size: 2rem; /* Badge text size on small screens */
        }
        .read-more-btn {
            font-size: 2rem; /* Font size for 'Read More' button on small screens */
        }
    }
...
<body>
    ...
    <div class="container mt-5">
        <h6 class="mb-4"><i class="fas fa-user icon"></i>Hi <?php echo $username; ?>! This platform allows you 
        to write any idea or problem you ever faced or 
        ...
        <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../message/message.html"><i class="fas fa-cogs"></i> chatroom</a>
                    </li>
        </div>
